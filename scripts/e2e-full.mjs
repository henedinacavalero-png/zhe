...
;(async () => {
  ...
  try {
    ...
    await page.waitForFunction(() => document.querySelector('.text-5xl')?.textContent === '15', { timeout: 30_000 })
    ...
    const exampleRuby = await page.locator('p.leading-relaxed ruby').count()
