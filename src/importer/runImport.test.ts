...
const GUESS = { term: 0, reading: 1, meaning: 2, example: 3, exampleZh: null, exampleRt: null } as const
...
describe('runImport 管线', () => {
  ...
  test('runImport：两阶段入库，related.wordId 指向真实主键，音频入库，进度两阶段合计到 100%', async () => {
    ...
    const deckId = await runImport(
      raw, { term: 0, reading: 1, meaning: 2, example: null, exampleZh: null, exampleRt: null }, '测试牌组',
